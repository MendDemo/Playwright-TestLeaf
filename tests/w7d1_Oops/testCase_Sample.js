...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(page, url) {
        ...
        this.myclassurl = url !== null && url !== void 0 ? url : "https://leafground.com/";
    }
    DashboardPage.prototype.navigate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.myclasspage.goto(this.myclassurl)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
function dashBoardTest() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, objDashboardPage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    page = _a.sent();
                    objDashboardPage = new DashboardPage(page, "https://leafground.com/dashboard.xhtml");
                    objDashboardPage.navigate();
                    return [2 /*return*/];
            }
        });
    });
